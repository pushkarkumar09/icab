...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="logo span4">
					<h1>
						<a href="">iApp Register <span class="red">.</span></a>
					</h1>
				</div>
	...
	<div class="register-container container">
		<div class="row">
			...
			<div class="register span6">
				<form:form action="/icab/saveOrder" method="POST"
					modelAttribute="orderDetails">
					<h2>
						Order <span class="red"><strong>Plz</strong></span>
					</h2>

					<form:label for="mobileNo" path="user.mobile">Mobile No:</form:label>
					<form:input type="text" id="mobileNo" name="mobileNo"
						placeholder="pls enter your mobile no.." path="user.mobile" />

					<form:label for="email" path="user.email">Email</form:label>
					<form:input type="text" id="email" name="email"
						placeholder="enter your email..." path="user.email" />
					...
					<div class="form-group">
						...
						<form:select path="order.type" class="form-control" id="min">
							<form:option value="">Select</form:option>
							<form:options items="${orderTypes}"/>						
						</form:select> 
		
						<label for="Order Description">Order Description</label>
						<form:textarea class="form-control" rows="3" id="desc" name="desc"
							placeholder="Enter order desc." path="order.description"></form:textarea>
							
						<label for="Order LOcation">Order to be Served at :</label>
						<form:textarea class="form-control" rows="3" id="location"
							name="location" placeholder="Enter order location." path="order.deliveryDetails.prefferedLocation.addressLine1"></form:textarea>
					</div>
					<div class="form-group">
						<label for="day">Select Preferred day:</label> 
						<form:select path="order.deliveryDetails.prefferedDay"
							class="form-control" id="day">
							<form:options items="${prefferedDay}"/>
						</form:select>
					</div>
					<div class="form-group">
						<label for="day">Select Preferred Timing:</label> <select
							class="form-control" id="hr">
							<option>12</option>
							<option>13</option>
						</select> .<select class="form-control" id="min">
							<option>00</option>
							<option>15</option>
							<option>30</option>
							<option>45</option>
	...
	<script type="text/javascript"
		src="<c:url value="js/jquery.backstretch.min.js"/>"></script>
